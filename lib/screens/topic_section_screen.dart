...
class _TopicSectionScreenState extends State<TopicSectionScreen> {
  ...
  String _sectionTitle(String? sectionId) {
    if (sectionId == 'topic1') {
      return 'पूज्य श्रीराधाबाबा संक्षिप्त जीवन परिचय';
    }
    if (sectionId == 'topic2') return 'निवेदन';
    if (sectionId == 'topic3') return 'अनुक्रमणिका (सार संक्षेप)';
    if (sectionId == 'topic4') return 'सरलार्थ (प्रियतम काव्य)';
    if (sectionId == 'topic5') return 'षोडश गीत';

    return switch (sectionId) {
      'topic1' =>
        'à¤ªà¥‚à¤œà¥à¤¯ à¤¶à¥à¤°à¥€à¤°à¤¾à¤§à¤¾à¤¬à¤¾à¤¬à¤¾ à¤¸à¤‚à¤•à¥à¤·à¤¿à¤ªà¥à¤¤ à¤œà¥€à¤µà¤¨ à¤ªà¤°à¤¿à¤šà¤¯',
      'topic2' => 'à¤¨à¤¿à¤µà¥‡à¤¦à¤¨',
      'topic3' =>
        'à¤…à¤¨à¥à¤•à¥à¤°à¤®à¤£à¤¿à¤•à¤¾ (à¤¸à¤¾à¤° à¤¸à¤‚à¤•à¥à¤·à¥‡à¤ª)',
      'topic4' =>
        'à¤¸à¤°à¤²à¤¾à¤°à¥à¤¥ (à¤ªà¥à¤°à¤¿à¤¯à¤¤à¤® à¤•à¤¾à¤µà¥à¤¯)',
      'topic5' => 'à¤•à¤¾à¤µà¥à¤¯-à¤®à¤¯ à¤¸à¤¨à¥à¤¦à¥‡à¤¶',
      _ => 'Topic',
    };
  }
}
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // यहाँ हमने साधारण Text विजेट को हटाकर अपना स्मार्ट विजेट लगा दिया है
              _buildFormattedText(content.body, defaultTextStyle, cs.primary),

              // बोल्ड फुटर (यदि हो तो)
